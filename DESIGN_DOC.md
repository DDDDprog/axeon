# Axeon Design Document

This document describes the architecture and implementation of Axeon
(Axon's C Compiler). For building, usage, and status information, see
[README.md](README.md). Each `src/` subdirectory also has its own
`README.md` with detailed per-module documentation.

---

## Table of Contopenhands@runtime-gbtcdtcggzyxkzgw-599666ccc6-vmd2r:/workspace/axeon$ axeon main.c
bash: axeon: command not found
openhands@runtime-gbtcdtcggzyxkzgw-599666ccc6-vmd2r:/workspace/axeon$ 
ents
