...
//! with source locations and renders them in Native format with
//! optional source snippet display and ANSI color output.
//!
//! # Warning control
//! The engine supports Native warning flags:
...
impl WarningKind {
    /// The Native flag name for this warning (without the -W prefix).
