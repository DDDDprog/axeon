        ...
        for arg in &args[1..] {
            match arg.as_str() {
                ...
                "--version" => {
                    ...
                    println!("Axeon C Compiler 14.2.0");
                    println!("Self-dependent C compiler with a native");
                    println!("assembler, linker, and optimizer.");
        ...
        while i < args.len() {
            match args[i].as_str() {
                ...
                "-m32" => {
                    ...
                    // (e.g. invoked as axeon-i686), this is a no-op.
                ...
                "-mlittle-endian" => {
                    ...
                    // This allows `axeon -mlittle-endian` to build ARM code without
                    // requiring the binary to be named aarch64-linux-gnu-axeon.
