...
pub enum TokenKind {
    ...
    // NEW Axeon keywords (modern syntax)
    Fn,          // fn - function keyword
    Let,         // let - variable declaration
    LetMut,      // mut - mutable keyword (renamed to avoid conflict)
    Class,       // class - object oriented
    Import,      // import - module import
    From,        // from - import ... from
    As,          // as - alias
    Try,         // try - error handling
    Catch,       // catch - error catching
    Throw,       // throw - throw error
    ThrowAtom,   // throw keyword
    Raise,       // raise exception
    ReturnArrow, // -> return type arrow
    And,         // and - logical and (&& replacement)
    Or,          // or - logical or (|| replacement)
    Not,         // not - logical not (! replacement)
    True,        // true - boolean true
    False,       // false - boolean false
    None,        // None - null/nil
    SelfToken,  // self keyword
    SelfType,    // Self - self type
    Super,       // super - parent class
    In,          // in - for...in loop
    Match,       // match - pattern matching
    Loop,       // loop - infinite loop
    // Const, For already exist in C keywords
...
impl std::fmt::Display for TokenKind {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            TokenKind::Throw | TokenKind::ThrowAtom => write!(f, "'throw'"),
            ...
            TokenKind::SelfToken => write!(f, "'self'"),
